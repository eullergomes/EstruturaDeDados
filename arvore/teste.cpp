...
No *criar_no() {
    ...
    // scanf("%d", &node->num);
    node->num = rand() % 100; //recebe um nº ale após digitar 1 no MENU
    printf("\n%d\n", node->num);
...
//3) verificar se o nó tem apenas um filho
...
//2) verificar se o nó é uma folha
